    ...
    do
        case "${cmd},${i}" in
            ...
            kat__config__help,locate)
                ...
                ;;
            kat__config__help,set)
                cmd="kat__config__help__set"
                ;;
            kat__help,config)
                cmd="kat__help__config"
                ;;
            kat__help,get)
                cmd="kat__help__get"
                ;;
            ...
            kat__help__config,locate)
                ...
                ;;
            kat__help__config,set)
                cmd="kat__help__config__set"
                ;;
            *)
                ;;
        esac
